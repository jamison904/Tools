...
import co.razoredge.shop.fragment.MainFragment;
import co.razoredge.shop.util.GlassActionBarHelper;
import co.razoredge.shop.util.Utils;
	...
	public boolean onOptionsItemSelected(MenuItem item)
	{
        switch(item.getItemId())
        {
            ...
            case R.id.emailButton:
				...
				startActivity(Intent.createChooser(emailIntent, "Contact Frank"));
            ...
            case R.id.gplusButton:
				...
				("https://plus.google.com/+RazorsEdgeBarbershopJacksonville"));
          		startActivity(gpCommunity);
                break;
			case R.id.map:
				Intent maps = new Intent(Intent.ACTION_VIEW).setData(Uri.parse
				("http://goo.gl/maps/XfRVc"));
          		startActivity(maps);
                break;
				}
                return true;
