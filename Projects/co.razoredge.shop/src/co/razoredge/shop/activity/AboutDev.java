...
public class AboutDev extends SherlockActivity {
	...
	@Override
      ...
      gplus = (ImageButton) findViewById(R.id.instagram_button);
      gplus.setOnClickListener(new OnClickListener() {
              public void onClick(View v) {
              	try {
              		final Intent intent = new Intent(Intent.ACTION_VIEW).setData(Uri.parse("http://i.instagram.com/razorsedge_co/"));
      ...
      twitter.setOnClickListener(new OnClickListener() {
              public void onClick(View v) {
              	try {
              		final Intent intent = new Intent(Intent.ACTION_VIEW).setData(Uri.parse("http://twitter.com/tar9mm"));
              		startActivity(intent);
              	} 
      ...
      facebook.setOnClickListener(new OnClickListener() {
              public void onClick(View v) {
              	try {
              		final Intent intent = new Intent(Intent.ACTION_VIEW).setData(Uri.parse("https://www.facebook.com/pages/Razors-Edge-Barbershop/179641895580413"));
              		startActivity(intent);
              	} 
              	catch (RuntimeException tw) {
              		tw.printStackTrace();
